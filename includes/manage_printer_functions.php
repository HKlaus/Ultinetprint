...
function verify_auth($ulti) {
	...
	if ($verify == "ok") return "Erfolgreich beim Drucker verifiziert.";
	else if ($verify == "Authorization required.") return "Fehler bei der Verifizierung, ID/Key-Paar nicht valide.";
	else return "Fehler bei der Verifizierung, der Drucker ist womöglich ausgeschaltet oder nicht am Netz.";
}
