...
function format_state($state) {
	...
	if ($state == "wait_cleanup" or $state == "wait_user_action" or $state == "queued") return "<span style='color:red; font-weight: 600;'>Drucker wartet auf Nutzereingabe!</span>" . $refresh_img;
